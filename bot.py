...
# -*- coding: utf-8 -*-
"""
PROXY RES Bot - Complete Version with Order Management System
"""
...
(WAITING_EMAIL, WAITING_PASSWORD, WAITING_NEW_EMAIL, WAITING_NEW_PASSWORD,
 WAITING_PAYMENT_PROOF, WAITING_PROXY_DETAILS, WAITING_PRICE_EDIT) = range(7)
...
payment_methods = {
    'crypto_btc': {'name': '₿ Bitcoin (BTC)', 'wallet': 'YOUR_BTC_WALLET'},
    'crypto_eth': {'name': '💎 Ethereum (ETH)', 'wallet': 'YOUR_ETH_WALLET'},
    'crypto_usdt': {'name': '💵 USDT (TRC20)', 'wallet': 'YOUR_USDT_WALLET'},
    'crypto_ltc': {'name': '🔷 Litecoin (LTC)', 'wallet': 'YOUR_LTC_WALLET'},
    'crypto_trx': {'name': '🔴 TRON (TRX)', 'wallet': 'YOUR_TRX_WALLET'},
    'payeer': {'name': '💳 Payeer', 'wallet': 'YOUR_PAYEER_WALLET'},
    'binance': {'name': '🟡 Binance Pay', 'wallet': 'YOUR_BINANCE_ID'},
    'bkash': {'name': '💰 bKash', 'wallet': 'YOUR_BKASH_NUMBER'},
    'nagad': {'name': '🟠 Nagad', 'wallet': 'YOUR_NAGAD_NUMBER'},
    'rocket': {'name': '🚀 Rocket', 'wallet': 'YOUR_ROCKET_NUMBER'}
}
...
"""
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("🔷 Litecoin (LTC)", callback_data="pay_crypto_ltc")],
        [InlineKeyboardButton("🔴 TRON (TRX)", callback_data="pay_crypto_trx")],
        [InlineKeyboardButton("💳 Payeer", callback_data="pay_payeer")],
...
async def receive_payment_proof(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Prepare order message for channel
...
Or send in any format you prefer.
